...
const projects = [
  {
    ...
    description:
      "After reading some books on productivity, I heard of the Pomodoro Timer technique for managing time. I tried a few tools and they worked fine, but I realized it would be a great learning experience to build one out myself. I set a goal to build a pomodoro timer app which runs entirely on the client (browser) using HTML, CSS, and Javascript.  The only dependencies were bootstrap and express.",
